...
namespace WpfApp1.Classes
{
    ...
    public static class RiskProfile
    {
        ...
        public static double min_Persent_ofDeposit { get; set; } = 20;       //мин % от депозита в сделке
        public static double max_Persent_ofDeposit { get; set; } = 40;       //макс % от депозита в сделке
